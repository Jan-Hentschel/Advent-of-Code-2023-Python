...
def determineType(line):
    ...
    card_count = Counter(list(cards))

    # Find the most common card and its count
    most_common_card = max(card_count, key=card_count.get)
    count_of_most_common_card = card_count[most_common_card]

    # Remove the most common card from the counter
    del card_count[most_common_card]

    # Find the second most common card and its count
    if card_count:
        # Find the second most common card and its count
        second_most_common_card = max(card_count, key=card_count.get)
        count_of_second_most_common_card = card_count[second_most_common_card]

        if "J" == most_common_card:
            print(cards)
            cards.replace("J", second_most_common_card)
            card_count = Counter(list(cards))
            ...
            print(cards)
        elif "J" == second_most_common_card:
            cards.replace("J", most_common_card)
            card_count = Counter(list(cards))
